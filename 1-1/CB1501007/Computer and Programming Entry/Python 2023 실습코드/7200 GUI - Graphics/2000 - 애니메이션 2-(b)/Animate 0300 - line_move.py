...
#Tkinter -- Canvas의 사용법을 배웁니다. (다양한 선들의 rotations)

from tkinter import *
import time
import math
root = Tk()
root.title("[Problem Solving-UI] Canvas (line move)")

cw = 600                                      # canvas width
ch = 600                                      # canvas height

chart_1 = Canvas(root, width=cw, height=ch, background="lightyellow")
